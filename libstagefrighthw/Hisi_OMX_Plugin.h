...
#ifndef HISI_OMX_PLUGIN

#define HISI_OMX_PLUGIN

#include <media/hardware/OMXPluginBase.h>

namespace android {

struct HisiOMXPlugin : public OMXPluginBase {
    HisiOMXPlugin();
    virtual ~HisiOMXPlugin();
...
private:
    ...
    HisiOMXPlugin(const HisiOMXPlugin &);
    HisiOMXPlugin &operator=(const HisiOMXPlugin &);
};

}  // namespace android

#endif  // HISI_OMX_PLUGIN
